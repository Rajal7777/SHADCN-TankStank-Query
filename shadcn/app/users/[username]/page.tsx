                ...
                <div className="w-full xl:w-1/3 space-y-6">
                    ...
                    <div className="bg-primary-foreground p-4 rounded-lg">
                        ...
                        <div className="flex gap-4 mt-4">
                            <HoverCard>
                                <HoverCardTrigger>
                                    <BadgeCheck size={36} className="rounded-full bg-blue-500/30 border borer-blue-500/30 p-1" />
                                </HoverCardTrigger>
                                <HoverCardContent>
                                    <h2 className="font-bold mb-2">Verified user</h2>
                                    <p className="font-sm text-muted-foreground">This user has been verified by the admin.</p>
                                </HoverCardContent>
                            </HoverCard>
                            <HoverCard>
                                <HoverCardTrigger>
